...
if __name__ == '__main__':
    root_dir = r'/fsx/yuchen/Urbansound8k/raw/UrbanSound8K/'
    data_dir = os.path.join(root_dir, 'audio')
    metadata_dir = os.path.join(root_dir, 'metadata')
    output_dir = '/fsx/yuchen/Urbansound8k/processed/'
    ...
    schema = zip(df8["slice_file_name"], df8["fsID"], df8["start"], df8["end"], df8["salience"], df8["classID"])
